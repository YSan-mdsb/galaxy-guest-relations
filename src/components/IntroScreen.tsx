...
export function IntroScreen({ onStart }: Props) {
    return (
        <div className="fixed inset-0 z-[100] bg-darkBg text-neonAmber font-mono flex items-center justify-center p-8">
            ...
            <motion.div
                ...
                className="max-w-3xl w-full border border-neonAmber/50 bg-darkBg/95 p-12 relative shadow-[0_0_50px_rgba(245,158,11,0.15)] box-glow-amber"
            >
                <div className="flex items-center gap-4 mb-8 border-b border-neonAmber/30 pb-4">
                    <Terminal size={32} className="text-crtGreen animate-pulse" />
                    <h1 className="text-3xl font-bold tracking-widest uppercase text-crtGreen glow-green m-0 leading-none">
                        ITA Command Interface
                    </h1>
                </div>

                <div className="space-y-6 text-base leading-relaxed text-neonAmber/90">
                    <motion.p
                ...
                >
                    <button
                        ...
                        className="px-10 py-4 text-xl font-bold tracking-[0.2em] uppercase bg-crtGreen/10 border-2 border-crtGreen text-crtGreen hover:bg-crtGreen hover:text-darkBg transition-all duration-300 relative group overflow-hidden"
                    >
